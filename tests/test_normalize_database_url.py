...
def test_strips_https_after_at():
    raw = "postgresql://u:p@https://host.pooler.supabase.com:6543/postgres"
    assert normalize_database_url(raw) == "postgresql://u:p@host.pooler.supabase.com:6543/postgres"
